...
public class VehicleRegNotFound {
    public VehicleRegNotFound(WebDriver driver){//constructor
        super();
        this.driver = driver;
    ...
    public void shouldVerifyErrorMessage(String errorMessage){
        Assert.assertTrue("Vehicle details could not be found", VehicleRegNotFound.getText().equalsIgnoreCase(errorMessage));
    }
}
